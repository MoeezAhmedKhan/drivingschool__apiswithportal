              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Package
                    </li>
                  </ol>
                </div>
              </div>
			...
			<div class="card">
				...
				<div class="card-content">
					...
					<form class="form-horizontal" method="POST">
    			    	...
    			    	<div class="col-sm-12">
							...
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                       <label>Hours</label>
                                   <input type="text" name="hours" class="form-control" value="<?php echo $arr[2] ?>">
                                    </div>
    							</div>
    						</div>
    			    	</div>
							...
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                       <label>Price</label>
                                   <input type="text" name="price" class="form-control" value="<?php echo $arr[3] ?>">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="package_edit_btn"  class="btn btn-primary">Submit</button>
                     </div>
					...
					<?php
                        ...
                        if(isset($_POST['package_edit_btn']))
                        {
                          ...
                          require_once('assets/connection.php');
                             ...
                             $update = "UPDATE `Packages` SET `Title`= '$title',`Hours`= '$hours' ,`Price`= '$price' WHERE Id = '$id'";
