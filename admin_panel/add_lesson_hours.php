...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new news.'){
       echo "<script>alert('Sucessfully added new class hours.')</script>";
       header("Refresh: 1; url='add_lesson_hours.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Lesson Hours</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add Lesson Hours
                    </li>
                  </ol>
                </div>
              </div>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Create Lesson Hours</h4>
				</div>
    			    	 ...
    			    	 <div class="col-sm-4">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                    <label>Start Time</label>
                                   <input type="time" name="start" class="form-control" placeholder="Select Start Time" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			    	<div class="col-sm-4">
							<div class="form-group">
								<div class="controls">
                                   ...
                                   <input type="time" name="end" class="form-control" placeholder="Select End Time" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			...
    			<!--    		<div class="col-sm-12">-->
							...
							<!--	<div class="controls">-->
       <!--                            <div class="controls">-->
       <!--                            <input type="text" name="price" class="form-control" placeholder="Enter Lesson Price" required="">-->
       <!--                             </div>-->
    			<!--				</div>-->
    			<!--			</div>-->
    			<!--    	</div>-->
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="lesson_hours_btn"  class="btn btn-primary">Submit</button>
                     </div>            
