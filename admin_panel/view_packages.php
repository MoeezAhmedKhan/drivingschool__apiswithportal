        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">View Packages</h2>
                              ...
                              <tbody>
                                ...
                                if($rec > 0)
                                {
                                    while($arr = mysqli_fetch_array($query))
                                    {
                                      ...
                                      <td>'.$arr[2].'</td>
                                      <td>'.$arr[3].'</td>
                                      <td><a href="package_edit.php?Id='.$arr[0].'"><i class="fa fa-edit" style="font-size:16px;color:#c18e3c "></i></a></td>
                                      </tr>';
                                    }
                                }
                                else
