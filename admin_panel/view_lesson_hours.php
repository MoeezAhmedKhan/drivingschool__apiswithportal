        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">View Lesson Hours</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">View Lessons Hours
                    </li>
                  </ol>
                </div>
              </div>
                  ...
                  <div class="col-md-12">
                      <div class="card ">
                        <div class="card-header">
                          <h4 class="card-title">Lessons Hours</h4>
                        </div>
                        <div class="card-body">
                          <div class="table-responsive">
                            <table class="table table-hover" id="">
                              ...
                              <tbody>
                                ...
                                $fetch = "SELECT c.id,c.lesson_id,c.date,c.start_time,c.end_time,c.status,u.First_name,u.Last_name,l.l_title FROM classes c INNER JOIN users u on u.id = c.teacher_id INNER JOIN lessons l on l.l_id = c.lesson_id";
                                ...
                                if($rec > 0)
                                {
                                    while($arr = mysqli_fetch_array($query))
                                    {
                                      ...
                                      <td>'.$arr['end_time'].'</td>
                                      <td>'.$arr['status'].'</td>
                                      <td><a href="lesson_hours_edit.php?Id='.$arr['id'].'"><i class="fa fa-edit" style="font-size:16px;color:#c18e3c "></i></a></td>
                                      </tr>';
                                    }
                                }
                                else
