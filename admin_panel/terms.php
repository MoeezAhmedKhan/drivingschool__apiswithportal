...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new news.'){
       ...
       header("Refresh: 1; url='addareas.php'");
        ...
        echo "<script>alert('Sucessfully added terms and condition.')</script>";
     }
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Terms and Conditions</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add Terms and Conditions
                    </li>
                  </ol>
                </div>
              </div>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Create Terms and Conditions</h4>
				</div>
				<div class="card-content">
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST">
							...
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="t_title" class="form-control" placeholder="Enter Title" required="">
                                    </div>
    							</div>
    						</div>
    			    	    </div>
							...
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                    <textarea name="t_desc" class="form-control" rows="6"></textarea>
                                    </div>
    							</div>
    						</div>
    			    	    </div>
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="terms_btn"  class="btn btn-primary">Submit</button>
                     </div>            
