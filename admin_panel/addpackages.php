...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new area.'){
       ...
       header("Refresh: 1; url='addpackages.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Package</h2>
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST">
    			    	 ...
    			    	 <div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="title" class="form-control" placeholder="Enter Package Titile" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			    	 ...
    			    	 <div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="hours" class="form-control" placeholder="Enter Package Hours" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="package_btn"  class="btn btn-primary">Submit</button>
                     </div>            
