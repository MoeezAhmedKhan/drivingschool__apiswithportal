        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Edit Terms and Condition</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit Terms/Condition
                    </li>
                  </ol>
                </div>
              </div>
				...
				<div class="card-content">
					...
					<form class="form-horizontal" method="POST">
					    ...
					    <?php
					        ...
					        $id = $_GET["Id"];
					        $select = "SELECT * FROM `terms_cond` WHERE Id = '$id'";
    			    	...
    			    	<div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                       <label>Title</label>
                                   <input type="text" name="title" class="form-control" value="<?php echo $arr[1] ?>">
                                    </div>
    							</div>
    						</div>
    			    	</div>
							...
							<div class="form-group">
								<div class="controls">
                                   ...
                                   <input type="text" name="desc" class="form-control" value="<?php echo $arr[2] ?>">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="term_edit_btn"  class="btn btn-primary">Submit</button>
                     </div>
					...
					<?php
                        ...
                        if(isset($_POST['term_edit_btn']))
                        {
                          ...
                          $update = "UPDATE `terms_cond` SET `Title`= '$title',`Description`= '$desc' WHERE Id = '$id'";
                          ...
                          if($update_query)
                          {
                               ...
                               ?>
                                <script>alert("Terms and Condition Updated");
                                window.location.href = "view_terms.php";
                                </script>
                             <?php
