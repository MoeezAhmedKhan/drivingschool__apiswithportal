...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new area.'){
       ...
       header("Refresh: 1; url='add_lesson.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Lessons</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add Lessons
                    </li>
                  </ol>
                </div>
              </div>
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST">
    			    	 ...
    			    	 <div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="color" class="form-control" placeholder="Enter Color Code" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="lesson_btn"  class="btn btn-primary">Submit</button>
                     </div>            
