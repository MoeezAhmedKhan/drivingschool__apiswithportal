        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">View Lessons</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">View Lessons
                    </li>
                  </ol>
                </div>
              </div>
                              ...
                              <tbody>
                                ...
                                if($rec > 0)
                                {
                                    while($arr = mysqli_fetch_array($query))
                                    {
                                      ...
                                      <td>'.$arr['l_title'].'</td>
                                      <td>'.$arr['color'].'</td>
                                      <td><a href="lesson_edit.php?Id='.$arr['l_id'].'"><i class="fa fa-edit" style="font-size:16px;color:#c18e3c "></i></a></td>
                                      </tr>';
                                    }
                                }
                                else
