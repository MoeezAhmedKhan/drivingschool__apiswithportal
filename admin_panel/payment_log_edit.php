...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new area.'){
       ...
       header("Refresh: 1; url='addareas.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Edit Log's</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit Log's
                    </li>
                  </ol>
                </div>
              </div>
				...
				<div class="card-content">
					...
					<form class="form-horizontal" method="POST">
					    ...
					    <?php
					        ...
					        $id = $_GET["Id"];
					        $select = "SELECT * FROM `payments` WHERE p_id = '$id'";
						...
						<div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                       <LABEL>User Id</LABEL>
                                   <input type="text" name="u_id" disabled class="form-control" value="<?php echo $arr[1] ?>" placeholder="User Id">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			    	...
    			    	<div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   ...
                                   <input type="text" name="c_id" disabled class="form-control" value="<?php echo $arr[2] ?>" placeholder="Class Id">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			        ...
    			        <div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   ...
                                   <input type="text" name="t_id" disabled class="form-control" value="<?php echo $arr[3] ?>" placeholder="Teacher Id">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			    	 ...
    			    	 <div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                       <label>Received By Teacher</label>
                                   <input type="text" name="r_by_teacher" disabled class="form-control" value="<?php echo $arr[4] ?>" placeholder="Received By Teacher">
                                    </div>
    							</div>
    						</div>
    			    	</div>
								...
								<div class="controls">
                                   <div class="controls">
                                       <label>Received By Admin</label>
                                        <select name="r_by_admin" class="form-control">
                                            <option value="Received" <?php if($arr[5] == "Received"){echo "selected";} ?>>Received</option>
                                            <option value="UnReceived" <?php if($arr[5] == "UnReceived"){echo "selected";} ?>>UnReceived</option>
                                        </select>
                                    </div>
    							</div>
    						</div>
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="payment_log_edit_btn"  class="btn btn-primary">Submit</button>
                     </div>
					...
					<?php
                        ...
                        if(isset($_POST['payment_log_edit_btn']))
                        {
                        
                        //   $u_id = $_POST['u_id']; 
                        //   $c_id = $_POST['c_id']; 
                        //   $t_id = $_POST['t_id']; 
                        //   $r_by_teacher = $_POST['r_by_teacher']; 
                          $rece_by_admin = $_POST['r_by_admin'];  
                         
                          require_once('assets/connection.php');
                          
                          
                                  
                                $update = "UPDATE `payments` SET `received_by_admin`='$rece_by_admin' WHERE `p_id` = '$id'";
                                
                                $run = mysqli_query($conn ,$update);
                                if($run)
                                {
                                   ?>
                                   <script>alert("Your update has been done.");window.location.href = "payment_log.php";</script>
                                   <?php
                                }
                                else
                                {
