...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new area.'){
       ...
       header("Refresh: 1; url='create_teachers_account.php'");

       
     }else{
        echo "<script>alert('Sucessfully added new teacher.')</script>";
     }
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Create teacher account</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Create teacher account
                    </li>
                  </ol>
                </div>
              </div>
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST" enctype="multipart/form-data">
    			        ...
    			        <div class="col-sm-6">
    			    	 ...
    			    	 <div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="file" name="frontimage" class="form-control" placeholder="Driving license front image">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			    	<div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="file" name="rearimage" class="form-control" placeholder="Driving license rear image">
                                    </div>
    							</div>
    						</div>
    			    	</div>
