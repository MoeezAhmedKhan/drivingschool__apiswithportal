				...
				<div class="card-content">
					...
					<form class="form-horizontal" method="POST">
					    ...
					    <?php
					        ...
					        $id = $_GET["Id"];
					        $select = "SELECT * FROM `lessons` WHERE l_id = '$id'";
    			    	...
    			    	<div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   ...
                                   <input type="text" name="title" class="form-control" value="<?php echo $arr['l_title'] ?>">
                                    </div>
    							</div>
    						</div>
    			    	</div>
							...
							<div class="form-group">
								<div class="controls">
                                   ...
                                   <input type="text" name="color" class="form-control" value="<?php echo $arr['color'] ?>">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="lesson_edit_btn"  class="btn btn-primary">Submit</button>
                     </div>
					...
					<?php
                        ...
                        if(isset($_POST['lesson_edit_btn']))
                        {
                          ...
                          $update = "UPDATE `lessons` SET `l_title`= '$title',`color`= '$color' WHERE l_id = '$id'";
                          ...
                          if($update_query)
                          {
                               ...
                               ?>
                                <script>alert("Lesson Updated");
                                window.location.href = "view_lesson.php";
                                </script>
                             <?php
