  ...
  if(isset($_GET['Massage'])){
      if($_GET['Massage'] == 'Sucessfully updated details.'){
         echo "<script>alert('Sucessfully updated details.')</script>";
          ...
          echo "<script>alert('News addedd successfully')</script>";
       }
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT `id`,`email`,`name`,`status` from `users` ";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            echo "<td><button  onclick='openAddMore({$row['id']},{$index})' >Update</button>
...
<div id="myModal" class="modal">
                  ...
                  <div class="form-group">
                    <div class="controls">
                     <select name="Status" id="Status"  class="form-control">
                            <option value="">Mark as banned</option>
                            <option value="">Mark as unbanned</option>
                      </select>
                    </div>
                  </div>
                </div>
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
        ...
        <h2>Edit News</h2>
         ...
         <input hidden type="text" name="id" id="id">  
             <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="text" name="name" id="Name" placeholder="Enter Name" > 
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control" value="" type="text" name="email" id="Email" placeholder="Enter Email" > 
                    </div>
                  </div>
       ...
       <button type="submit" name="btnUpdateOwner" class="btn btn-primary">Submit</button>
       </form>
      </div>
...
var modal_Add = document.getElementById("myModal_Add");
 ...
 function openAddMore(id,index){
     ...
     document.getElementById('Name').value = document.getElementsByName('name')[index].innerText;
     document.getElementById('Email').value = document.getElementsByName('email')[index].innerText;
     document.getElementById('Status').value = document.getElementsByName('status')[index].innerText;
...
function deleteRow(id){
    var req = new XMLHttpRequest();
      req.open("get","assets/Actions.php?FunctionName=DeleteUser&id="+id,true);
      req.send();
