        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">View Terms and Conditions</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">View Terms/Condition
                    </li>
                  </ol>
                </div>
              </div>
                              ...
                              <tbody>
                                ...
                                if($rec > 0)
                                {
                                    while($arr = mysqli_fetch_array($query))
                                    {
                                      ...
                                      <td>'.$arr[1].'</td>
                                      <td>'.$arr[2].'</td>
                                      <td><a href="term_edit.php?Id='.$arr[0].'"><i class="fa fa-edit" style="font-size:16px;color:#c18e3c "></i></a></td>
                                      </tr>';
                                    }
                                }
                                else
