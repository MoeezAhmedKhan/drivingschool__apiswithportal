        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Edit Student</h2>
	...
	<div class="row">
      ...
      <!--                              </div>-->
    		...
    		<!--	    	</div>-->
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="student_edit_btn"  class="btn btn-primary">Submit</button>
                     </div>
					...
					<?php
                        ...
                        if(isset($_POST['student_edit_btn']))
                        {
                          ...
                          $update = "UPDATE `users` SET `First_name`= '$fname',`email`= '$email',`Phone`= '$phone',`City`= '$city',`Address`= '$address',`Zip_code`= '$zip',`password`= '$password',`Status`= '$status' WHERE id = '$id'";
                          ...
                          if($update_query)
                          {
                               ...
                               ?>
                                <script>alert("Student record Updated");
