        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Payment Logs</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Payment Logs
                    </li>
                  </ol>
                </div>
              </div>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Payment Received by admin</h4>
				</div>
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST" enctype="multipart/form-data">
    			        ...
    			        <div class="col-sm-6">
    			    	 ...
    			    	 <div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="frontimage" class="form-control" placeholder="Driving license front image">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			    	<div class="col-sm-12">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="rearimage" class="form-control" placeholder="Driving license rear image">
                                    </div>
    							</div>
    						</div>
    			    	</div>
