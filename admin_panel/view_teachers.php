        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Teacher Records</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Teacher Records
                    </li>
                  </ol>
                </div>
              </div>
                            ...
                            <table class="table table-hover" id="">
                              <thead class=" text-primary">
                                <tr>
                                  ...
                                  <th>Address</th>
                                  <th>Zip Code</th>
                                  <th>Driving license front image</th>
                                  <th>Driving license rear image</th>
                                  <th>Password</th>
                                  <th>Status</th>
                                  <th>Created At</th>
                                  <th>Action</th>
                              ...
                              <tbody>
                                ...
                                $fetch = "SELECT * FROM `users` where role_id = 1";
                                ...
                                if($rec > 0)
                                {
                                    while($arr = mysqli_fetch_array($query))
                                    {
                                      ...
                                      <td>'.$arr['Address'].'</td>
                                      <td>'.$arr['Zip_code'].'</td>
                                      <td class="text-center"><a href="https://sassolution.org/driving_school/admin_panel/Uploads/'.$arr['Driving_license_front_image'].'"><img id="pop1" src="https://sassolution.org/driving_school/admin_panel/Uploads/'.$arr['Driving_license_front_image'].'" height="30"></a></td>
                                   `` <td class="text-center"><a href="https://sassolution.org/driving_school/admin_panel/Uploads/'.$arr['Driving_license_rear_image'].'"><img id="pop2" src="https://sassolution.org/driving_school/admin_panel/Uploads/'.$arr['Driving_license_rear_image'].'" height="30"></a></td>
                                      <td>'.$arr['password'].'</td>
                                      <td>'.$arr['Status'].'</td>
                                      <td>'.$arr['created_at'].'</td>
                                      
                                      <td><a href="teacher_edit.php?Id='.$arr[0].'"><i class="fa fa-edit" style="font-size:16px;color:#c18e3c "></i></a></td>
                                      </tr>';
                                    }
                                }
                                else
